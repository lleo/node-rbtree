 ...
 *
 * @method deleteLeast
 * @return {Array} `[key, value]` of least node
 */
RBTree.prototype.deleteLeast = function(){
  var node = this._findLeast()

  if (!node) return undefined

  if ( !this.deleteNode(node) ) {
    throw new Error("failed to delete least node key=%j", node.key)
  }
 ...
 *
 * @method deleteGreatest
 * @return {Array} `[key, value]` of greatest node
 */
RBTree.prototype.deleteGreatest = function(){
  var node = this._findGreatest()

  if (!node) return undefined

  if ( !this.deleteNode(node) ) {
    throw new Error("failed to delete greatest node key=%j", node.key)
  }
 ...
 */
RBTree.prototype._deleteNode = function(cur){
  if (!cur) return false
...
var constNullProp = { value        : null
                    , writable     : false
                    , configurable : false
                    , enumerable   : true  }
var constBlackProp = { value        : BLACK
                     , writable     : false
                     , configurable : false
                     , enumerable   : true   }
function Nil() {
  ...
  Object.defineProperty(this, 'ln'   , constNullProp)
  Object.defineProperty(this, 'rn'   , constNullProp)
